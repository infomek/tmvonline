...
const StudentLogin: React.FC<StudentLoginProps> = ({ onBack, onLoginSuccess, onForgotPassword }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (prn === '04422000371' && password === 'ashwin1245') {
      ...
      onLoginSuccess(); // This will trigger the dashboard view
    } else {
      alert('Invalid PRN or Password. Please try again.');
    }
  };
        ...
        <div className="bg-white rounded-lg shadow-2xl p-8 w-full max-w-md">
          ...
          <div className="mt-6 space-y-3">
            <div className="flex justify-between text-sm">
              ...
              <span />
              <button onClick={onForgotPassword} className="text-blue-600 hover:text-blue-800">Forgot Password?</button>
            </div>
            <div className="text-center">
              <a href="#" className="text-blue-600 hover:text-blue-800 text-sm">Student User Manual</a>
            </div>
          </div>
          ...
          <div className="mt-8 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            ...
            <ul className="text-sm text-gray-700 space-y-1">
              ...
              <li><strong>Detail mail:</strong> PRN and Detail query/issue and screenshot must be there.</li>
          ...
          <button
            onClick={onBack}
            className="mt-6 flex items-center text-gray-600 hover:text-gray-900 transition-colors duration-200"
          >
